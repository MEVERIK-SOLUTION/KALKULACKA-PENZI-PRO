  ...
  <div class="min-h-screen py-8" :class="isDark ? 'dark' : ''">
    <div class="container mx-auto px-4 max-w-6xl">
      ...
      <div class="bg-white dark:bg-[#16213e] rounded-lg shadow-md transition-colors duration-300">
        <div class="flex border-b-2 border-gray-100 dark:border-[#2d3748] overflow-x-auto">
          <div
            v-for="tab in tabs"
            :key="tab.id"
        ...
        <div class="p-6 text-gray-800 dark:text-gray-100">
          ...
          <div v-if="activeTab === 'pension'" class="space-y-4">
            ...
            <div v-if="store.hasResult" class="mt-6 p-6 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800 transition-colors duration-300">
